...
class gps(object):
    ...
    def compute_gps(self,px, py, bear, alti, cent_lat, cent_lon,frame_shape):
        ...
        dist = dist*5
        print("Distance from camera to object is: ", dist)

        dist /= 1000
        pt = geopy.Point(cent_lat,cent_lon)
        obj = geopy.distance.geodesic(kilometers=dist)
...
if __name__ == "__main__":
    ...
    #obj.algo()
    obj= gps()
    print(gps.compute_gps(obj,4800,2555,48.8,20.5,28.,77.11790875,(5312,2800,0)))
    pass
